...
if (is_admin()) {
    ...
    function cardealer_this_screen()
    {
        ...
        if ($current_screen->id === "edit-cardealerfields") {
            add_filter('contextual_help', 'CarDealer_contextual_help_fields', 10, 3);
        } elseif ($current_screen->id === "cars") {
            add_filter('contextual_help', 'CarDealer_contextual_help_cars', 10, 3);
        } elseif ($current_screen->id === "edit-team") {
            add_filter('contextual_help', 'CarDealer_contextual_help_agents', 10, 3);
        } elseif ($current_screen->id === "edit-locations") {
            add_filter('contextual_help', 'CarDealer_contextual_help_locations', 10, 3);
        } elseif ($current_screen->id === "edit-makes") {
            add_filter('contextual_help', 'CarDealer_contextual_help_makes', 10, 3);
        } elseif ($current_screen->id === "toplevel_page_car_dealer_plugin" or $current_screen->id === "admin_page_cardealer_settings") {
            add_filter('contextual_help', 'CarDealer_main_help', 10, 3);
        } else {
            if (isset($_GET['page'])) {
...
function CarDealer_main_help($contextual_help, $screen_id, $screen)
{
...
function CarDealer_contextual_help_fields($contextual_help, $screen_id, $screen)
{
...
function CarDealer_contextual_help_cars($contextual_help, $screen_id, $screen)
{
...
function CarDealer_contextual_help_agents($contextual_help, $screen_id, $screen)
{
...
function CarDealer_contextual_help_locations($contextual_help, $screen_id, $screen)
{
...
function CarDealer_contextual_help_makes($contextual_help, $screen_id, $screen)
{
    $myhelpMake = 'Use the Makes control it is optional.
    To add new makes, go to:
    <br />
