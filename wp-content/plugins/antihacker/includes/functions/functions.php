...
$antihacker_http_tools = trim(sanitize_text_field(get_site_option('antihacker_http_tools', '')));
$aantihacker_http_tools = explode(" ", $antihacker_http_tools);


if (version_compare(trim(ANTIHACKERVERSION), trim(ANTIHACKERVERSIONANT)) > 0 or empty($antihacker_http_tools)) {
    $antihacker_http_tools = trim(sanitize_text_field(get_site_option('antihacker_http_tools', '')));
    $aantihacker_http_tools = explode(" ", $antihacker_http_tools);
    if (empty($antihacker_http_tools))
...
$antihacker_table = $wpdb->prefix . "ah_fingerprint";
$query = "SELECT fingerprint from " . $antihacker_table . " 
...
function ah_successful_login($user_login)
{
    ...
    global $antihacker_my_radio_report_all_visits;
    global $antihackerip;
    global $ah_admin_email;
    if (ah_whitelisted($antihackerip, $amy_whitelist) and $antihacker_my_radio_report_all_visits <> 'Yes') {
        return 1;
    }
    $dt = date("Y-m-d H:i:s");
...
function antihacker_alertme10()
{
    ...
    global  $antihacker_current_url;
    $subject = __("Detected Bot on ", "antihacker") . $antihackerserver;
    $message[] = __("Malicious bot was detected and blocked because using HTTP Tools.", "antihacker");
    $message[] = "";
    $message[] = __('Date', 'antihacker') . "..............: " . date("F j, Y, g:i a");
    $message[] = __('Robot IP Address', 'antihacker') . "..: " . $antihackerip;
    $message[] = "";
...
function antihacker_alertme11()
{
    ...
    global  $antihacker_current_url;
    $subject = __("Detected Bot on ", "antihacker") . $antihackerserver;
    $message[] = __("Malicious bot was detected and blocked because attempt to Login.", "antihacker");
    $message[] = "";
    $message[] = __('Date', 'antihacker') . "..............: " . date("F j, Y, g:i a");
    $message[] = __('Robot IP Address', 'antihacker') . "..: " . $antihackerip;
    $message[] = "";
...
function antihacker_alertme12()
{
    ...
    global  $antihacker_current_url;
    $subject = __("Detected Bot on ", "antihacker") . $antihackerserver;
    $message[] = __("Malicious bot was detected and blocked because Blank User Agent.", "antihacker");
    $message[] = "";
    $message[] = __('Date', 'antihacker') . "..............: " . date("F j, Y, g:i a");
    $message[] = __('Robot IP Address', 'antihacker') . "..: " . $antihackerip;
    $message[] = "";
...
function antihacker_alertme13()
{
    ...
    global  $antihacker_current_url;
    $subject = __("Detected Bot on ", "antihacker") . $antihackerserver;
    $message[] = __("Malicious bot was detected and blocked because attempt to Login with Bot.", "antihacker");
    $message[] = "";
    $message[] = __('Date', 'antihacker') . "..............: " . date("F j, Y, g:i a");
    $message[] = __('Robot IP Address', 'antihacker') . "..: " . $antihackerip;
    $message[] = "";
...
function antihacker_alertme14()
{
    ...
    global  $antihacker_current_url;
    $subject = __("Detected Bot on ", "antihacker") . $antihackerserver;
    $message[] = __("Malicious bot was detected and blocked because excedeed number page open limit", "antihacker");
    $message[] = "";
    $message[] = __('Date', 'antihacker') . "..............: " . date("F j, Y, g:i a");
    $message[] = __('Robot IP Address', 'antihacker') . "..: " . $antihackerip;
    $message[] = "";
...
function antihacker_alertme15()
{
    ...
    global  $antihacker_current_url;
    $subject = __("Detected Bot on ", "antihacker") . $antihackerserver;
    $message[] = __("Bot was detected and blocked because accessing xmlrpc.php file and it was blocked on settings page.", "antihacker");
    $message[] = "";
    $message[] = __('Date', 'antihacker') . "..............: " . date("F j, Y, g:i a");
    $message[] = __('Robot IP Address', 'antihacker') . "..: " . $antihackerip;
    $message[] = "";
...
function antihacker_block_httptools()
{
    ...
    for ($i = 0; $i < count($aantihacker_http_tools); $i++) {
        $toolnickname = $aantihacker_http_tools[$i];
...
function antihacker_create_httptools()
{
    ...
    if (!add_option('antihacker_http_tools', $text)) {
...
function antihacker_check_httptools()
{
    ...
    if (!empty($antihacker_ua) and !is_admin()  and  !is_super_admin() and !ah_whitelisted($antihackerip, $amy_whitelist)) {
        if (antihacker_block_httptools() and $antihacker_block_http_tools != 'no') {
...
function antihacker_grava_fingerprint()
{
    ...
    if (isset($_REQUEST)) {
        ...
        require_once ABSPATH . 'wp-admin/includes/upgrade.php';
        $mytable_name = "wp_ah_fingerprint";
    ...
    <div class="antihacker_bill_go_pro_message antihacker_bill_banner_on_plugin_page antihacker_bill_go_pro_banner">
        ...
        <div class="antihacker_bill_go_pro_buttons">
            ...
            <div class="antihacker_bill_go_pro_dismiss_container">
                <a class="button button-secondary antihacker_bill_go_pro_dismiss" target="_blank"
                    href="http://antihackerplugin.com/premium/"><?php echo __(
                                                                                                                                                        'Dismiss',
                                                                                                                                                        'antihacker'
                                                                                                                                                    ); ?></a>
            </div>
