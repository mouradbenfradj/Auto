(function ($) {
    'use strict';
    wp.conceptlycustomizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                conceptly_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.conceptlycustomizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.conceptlycustomizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.conceptlycustomizerRepeater.iconPickerToggle($(this));
        });
